...
<html>
    <head>
        ...
        <%
            ...
            String parkingNumberOfSpaces = request.getParameter("numberOfSpaces");
    ...
    <center>
      <body background="imagenes/7.jpg">
        ...
        <a href="ParkingRetrievalServlet">Consultar parqueos</a><br>
        <a href="insert_parkingLot.jsp">Insertar otro parqueo</a><br>
    </body>
    </center>
