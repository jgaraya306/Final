...
<html >
    ...
    <center>
        ...
        <br><br>    <font size="5"><a style="color:#2E2E2E" href="VehicleRetrievalServlet">Refrescar tabla</a></font>
        <br><br>    <font size="5"><a style="color:#2E2E2E" href="FuncionesDeAdministrador.jsp">Cambiar de operacion</a></font>
        <br><br>    <font size="5"><a style="color:#2E2E2E" href="index.html" >Volver al menu principal</a></font>
