...
<html>
    ...
    <center>
                <i>
           <b><font color="black" size="8">Lista de los trabajadores en el Sistema </font></b>            
        </i>
        <table border="2">
            ...
            <d:forEach items="${clerks}" var="currentClerk" varStatus="counter">
                ...
                <tr bgcolor= "${color}">
                    ...
                    <td><font size="5"><a href="ClerkManagementServlet.do?action=edit&clerkUsername=<d:out value="${currentClerk.username}"/>">Modificar</a></font>
                        <font size="5"><a href="ClerkManagementServlet.do?action=delete&clerkUsername=<d:out value="${currentClerk.username}"/>">Eliminar</a></font></td>
                </tr>
        ...
        <br><br>
        <font size="5"><a style="color:#424242" href="index.html">Regresar al menú</a><br><br><font>
