...
<html>
  ...
  <body background="imagenes/7.jpg">
    <center>
        ...
        <hr/>
        <br><font size="6"><a style="color:#BDBDBD" href="ReservarEspacio.jsp">Reservar su espacio en el parqueo</a><br><br>
        <a style="color:#BDBDBD" href="index.html">Regresar a la pantalla de inicio</a></font>
    </center>
</body>
